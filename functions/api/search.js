...
// Fallback1: Tavily     (env.TAVILY_API_KEY)
// Fallback2: Google CSE (env.GOOGLE_API_KEY + env.GOOGLE_CX) — 100/day free
// Fallback3: SearXNG    (env.SEARXNG_URL)
// Last:      LangSearch (env.LANGSEARCH_API_KEY)
...
export async function onRequestPost(context) {
  ...
  // 3️⃣ Google CSE (Fallback2 — 100/day free)
